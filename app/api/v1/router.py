...
from app.api.v1 import auth, users, projects, documents, ingestion, search, audit, activity, api_keys, rfp_questions, rephrase, analytics, email, endpoint_logs, access_intelligence
...
api_router.include_router(email.router, prefix="")
